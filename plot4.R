## this is the fourth of the four programming assignments
...
if( file.exists("hpc.rds") ) {
  ...
  saveRDS(hpc, file="hpc.rds")
   ...
   ##  Now create our fourth plot, which is really 4 graphs on one display
par( mfcol=c(2,2))
...
png(filename="plot4.png", width=480, height=480)  ## this opened the plotting file
