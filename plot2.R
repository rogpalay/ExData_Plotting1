## this is the second of the four programming assignments
...
if( file.exists("hpc.rds") ) {
  ...
  saveRDS(hpc, file="hpc.rds")
   ...
   ##  Now create our second plot

plot(hpc$Time,hpc$Global_active_power,type="l",
     ylab="Global Active Power (kilowatts)", xlab=""
)

png(filename="plot2.png", width=480, height=480)  ## this opened the plotting file
